...
export class VentaVehiculoController {
  ...
  @get('/ventas/{id}/vehiculo', {
    responses: {
      '200': {
        description: 'Venta has one Vehiculo',
        content: {
          'application/json': {
  ...
  async get(
    ...
    return this.ventaRepository.vehiculo(id).get(filter);
  }

  @post('/ventas/{id}/vehiculo', {
    responses: {
      '200': {
  ...
  async create(
    ...
    return this.ventaRepository.vehiculo(id).create(vehiculo);
  }

  @patch('/ventas/{id}/vehiculo', {
    responses: {
      '200': {
  ...
  async patch(
    ...
    return this.ventaRepository.vehiculo(id).patch(vehiculo, where);
  }

  @del('/ventas/{id}/vehiculo', {
    responses: {
      '200': {
  ...
  async delete(
    ...
    return this.ventaRepository.vehiculo(id).delete(where);
  }
}
